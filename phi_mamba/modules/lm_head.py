    ...
    def create_updated_config(self):
        ...
        for idx, layer in enumerate(self.backbone.layers):
            ...
            if type(layer.mixer) == MambaMixer:
                ...
                new_block_config['core_input']['inner_hidden_size'] = layer.mixer.self_attn.inner_hidden_size if hasattr(layer.mixer.self_attn, 'inner_hidden_size') else layer.mixer.self_attn.intermediate_size
