...
from modules.modeling_llama import LLAMA_ATTENTION_CLASSES


class Mixer(nn.Module):
    def __init__(self, layer_idx, hf_config=None, **kwargs):
        super().__init__()
        self.model_cfg = hf_config if hf_config is not None else kwargs
    ...
    def create_mask(self, hidden_states, offset=0):
        ...
        if self.self_attn.__class__ == LLAMA_ATTENTION_CLASSES["eager"]:
