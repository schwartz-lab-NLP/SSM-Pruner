...
from modules.modeling_phi_adjusted import PHI_ATTENTION_CLASSES, PhiConfig
...
class Mixer(nn.Module):
    def __init__(self, layer_idx, **kwargs):
        ...
        self.self_attn = PHI_ATTENTION_CLASSES[attn_type](
            PhiConfig(self.model_cfg),
            layer_idx,
            kwargs.get("inner_hidden_size", None),
            kwargs.get("num_attention_heads", None),
            kwargs.get("num_key_value_heads", None),
        )
